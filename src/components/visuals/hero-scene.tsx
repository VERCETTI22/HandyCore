...
export function HeroScene({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <ellipse cx="486" cy="132" rx="24" ry="5" fill="#d9a64e" />
      ...
      <rect x="314" y="272" width="12" height="26" rx="2" fill="#d9a64e" />
      <rect x="330" y="262" width="12" height="36" rx="2" fill="#2b2f36" />
      <g>
        <rect x="416" y="270" width="30" height="28" rx="4" fill="#121212" />
        <rect x="421" y="275" width="20" height="18" rx="2" fill="#d9a64e" />
      </g>
      ...
      <path d="M367 282 C 374 270 378 264 372 256 C 368 268 366 274 367 282 Z" fill="#d9a64e" />

      {/* ---- rug ---- */}
      <ellipse cx="330" cy="690" rx="220" ry="34" fill="#faf3e3" />
      <ellipse cx="330" cy="690" rx="220" ry="34" fill="none" stroke="#d9a64e" strokeOpacity="0.4" strokeWidth="2" />
      ...
      <g strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* tool belt */}
        <rect x="312" y="430" width="108" height="18" rx="4" fill="#d9a64e" />
        ...
        {/* cap */}
        <path d="M338 258 q2 -30 30 -30 q28 0 30 28 q-30 -10 -60 2 z" fill="#d9a64e" />
      ...
      <g>
        ...
        <rect x="248" y="316" width="16" height="9" rx="3" fill="#d9a64e" transform="rotate(-32 256 320)" />
        <rect x="226" y="290" width="16" height="7" rx="3" fill="#3c434d" transform="rotate(-32 234 293)" />
        <circle cx="223" cy="289" r="3.4" fill="#d9a64e" />
      </g>
      ...
      <g>
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <rect x="134" y="582" width="68" height="4" rx="2" fill="#d9a64e" opacity="0.85" />
      </g>
    </svg>
  );
}
